...
This example requires that you have [DOLPHOT](http://americano.dolphinsim.com/dolphot/) and its ACS module installed. It's best if you have compiled it with [PGPLOT](http://www.astro.caltech.edu/~tjp/pgplot/), if at all possible.


The data used for this example are 'Grid 4' HST/ACS images from [HST-GO-12180](http://www.stsci.edu/cgi-bin/get-proposal-info?id=12180&submit=Go&observatory=HST) as presnted in [Cannon et al. (2012)](http://adsabs.harvard.edu/abs/2012ApJ...747..122C).  Let's assume we have the raw images from the HST archive in the 'raw' subdirectory of 'NGC6822':
...
img1_file = jbin02exq_flc.chip1
img1_shift = 0 0
img1_xform = 1 0 0
img2_file = jbin02exq_flc.chip2
img2_shift = 0 0
img2_xform = 1 0 0
img3_file = jbin02ezq_flc.chip1
img3_shift = 0 0
img3_xform = 1 0 0
img4_file = jbin02ezq_flc.chip2
img4_shift = 0 0
img4_xform = 1 0 0
